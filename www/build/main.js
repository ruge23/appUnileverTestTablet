                    ...
                    buttons: [
                        {
                            ...
                            handler: function (data) {
                                if (data.nombre != "" && data.apellido != "" && data.id != "") {
                                    var status_1 = _this.manager.crearParticipanteLocal(data.nombre, data.apellido, data.id);
                                    if (status_1 == 200) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_base64_to_gallery__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_photo_library__ = __webpack_require__(206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SecondPage = /** @class */ (function () {
    function SecondPage(navCtrl, navParams, alertCtrl, mdprovider, platform, base64ToGallery, loadingCtrl, photoLibrary) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
    ...
    SecondPage.prototype.descargar = function () {
        var _this = this;
        this.fotomergeada = this.homepagecanvas.nativeElement.toDataURL();
        var nombre = this.mdprovider.getParticipanteNombre();
        this.photoLibrary.requestAuthorization().then(function () {
            _this.photoLibrary.saveImage(_this.fotomergeada, nombre).then(function (res) {
                _this.showAlertConfirm();
    ...
    SecondPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_managedata_managedata__["a" /* ManagedataProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_3__ionic_native_base64_to_gallery__["a" /* Base64ToGallery */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera_preview__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_screenshot__ = __webpack_require__(403);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_managedata_managedata__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_base64__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_base64_to_gallery__ = __webpack_require__(204);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_photo_library__ = __webpack_require__(206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators__ = __webpack_require__(279);
...
var ManagedataProvider = /** @class */ (function () {
    function ManagedataProvider(http, localstorage) {
        this.http = http;
    ...
    ManagedataProvider.prototype.crearParticipanteLocal = function (nombre, apellido, idempleado) {
        this.participanteLocal = nombre + "-" + apellido + "-" + idempleado;
        return 200;
    };
    ManagedataProvider.prototype.getParticipanteNombre = function () {
        return this.participanteLocal;
    };
